    ...
    <div className="min-h-screen bg-gradient-to-br from-burgundy-900 to-burgundy-800 flex items-center justify-center px-4 py-12">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
        ...
        <div className="bg-burgundy-900 text-white p-6 rounded-t-lg">
          ...
          <p className="text-burgundy-100 text-center mt-2">Welcome back to our perfume collection</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          {error && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-red-800">Login Error</h3>
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <Link href="#" className="text-burgundy-600 hover:text-burgundy-700 font-medium">
              Forgot password?
            </Link>
          </div>
        ...
        {/* Demo Account Info */}
        <div className="bg-blue-50 px-6 py-4 border-t border-blue-200 rounded-b-lg">
          <p className="text-xs text-blue-700">
            <strong>Demo Account:</strong> Use test@example.com with password: password123 (after registration)
          </p>
        </div>
